...
function bindClassification(){['cfCreateTitle','cfCreateSubject','cfCreateLevel','cfCreateClass'].forEach(id=>document.getElementById(id)?.addEventListener('change',refreshClassificationOptions));bindCustomSelect('cfCreateTitle','cfCreateTitleCustom');const themeInput=document.getElementById('cfCreateThemeColor'),themeValue=document.getElementById('cfCreateThemeColorValue');const syncThemeColor=()=>{if(themeInput&&themeValue)themeValue.textContent=normalizeThemeColor(themeInput.value)};themeInput?.addEventListener('input',syncThemeColor);syncThemeColor();bindCustomSelect('cfCreateSubject','cfCreateSubjectCustom');bindCustomSelect('cfCreateLevel','cfCreateLevelCustom');bindCustomSelect('cfCreateClass','cfCreateClassCustom');loadClassificationOptions();}
