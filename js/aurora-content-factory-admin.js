...
[data-theme="dark"] #cfThemeModal .cf-theme-modal-card p{color:#b8b2c9!important}
[data-theme="dark"] #cfThemeModal .cf-theme-modal-kicker{color:#ddd6fe!important;opacity:.9}
[data-theme="dark"] #cfThemeModal .cf-theme-modal-picker{background:#17142a!important;border-color:#3a3452!important;color:#f7f5ff!important}
[data-theme="dark"] #cfThemeModal .cf-theme-modal-picker strong{color:#f7f5ff!important}
[data-theme="dark"] #cfThemeModal .cf-theme-modal-picker span{color:#b8b2c9!important}
[data-theme="dark"] #cfThemeModal .cf-theme-swatch{background:#17142a!important;color:#f7f5ff!important;border-color:#3a3452!important}
[data-theme="dark"] #cfThemeModal .cf-theme-swatch:hover{background:#211d38!important;border-color:#5a5278!important}
[data-theme="dark"] #cfThemeModal .cf-theme-swatch.is-selected{border-color:#f7f5ff!important;box-shadow:0 0 0 2px rgba(167,139,250,.35)!important}
[data-theme="dark"] #cfThemeModal .cf-theme-swatch-code{color:#b8b2c9!important;opacity:.9}
[data-theme="dark"] #cfThemeModal .cf-theme-modal-actions .admin-btn.ghost{background:#17142a!important;color:#f7f5ff!important;border-color:#3a3452!important}
[data-theme="dark"] #cfThemeModal .cf-theme-modal-actions .admin-btn.primary{background:#7c3aed!important;color:#fff!important;border-color:#7c3aed!important}
@media(max-width:650px){.cf-theme-swatches{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:430px){.cf-theme-modal-card{padding:14px}.cf-theme-swatches{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.cf-theme-swatch{min-height:48px}.cf-theme-swatch-dot{flex-basis:28px;width:28px;height:28px}.cf-theme-swatch-name{font-size:.66rem}.cf-theme-swatch-code{font-size:.54rem}}@media(max-width:560px){.cf-theme-modal-actions .admin-btn{width:100%;justify-content:center}}';
