...
def normalize_math(s):
    ...
    for command in ("eq", "otin", "exists", "abla", "mid", "parallel"):
        s = s.replace(chr(10) + command, chr(92) + "n" + command)
...
def main():
    ...
    is_math_subject = "math" in clean_text(data.get("subject") or "").lower()
