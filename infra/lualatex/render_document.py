...
def render(data):
    ...
    lines = [
        ...
        r"  \\begin{tcolorbox}[enhanced,colback=white!97!aurorepale,colframe=aurorebase!34!white,arc=18pt,boxrule=.6pt,left=15pt,right=15pt,top=13pt,bottom=16pt,borderline west={3.2pt}{0pt}{auroreprimary!88!white},borderline north={0.9pt}{0pt}{auroresecondary!65!white}]%",
        r"    \\begin{tabularx}{\\linewidth}{@{}p{1.38cm}X@{}}",
        r"      \\begin{tcolorbox}[enhanced,colback=white,colframe=aurorebase!55!white,arc=7pt,boxrule=.55pt,left=2pt,right=2pt,top=2pt,bottom=2pt,width=1.22cm,height=1.22cm,valign=center]",
        r"        \\IfFileExists{assets/aurore-logo.png}{\\includegraphics[width=1.04cm,height=1.04cm,keepaspectratio]{assets/aurore-logo.png}}{\\textcolor{aurorebase}{\\rule{.82cm}{.82cm}}}%",
        r"      \\end{tcolorbox} &",
        r"      \\begin{minipage}[c]{\\linewidth}\\centering",
        r"        {\\sffamily\\fontsize{8.5}{10}\\selectfont\\bfseries\\color{aurorebase!82!black}AURORE\\enspace /\\enspace SECTION ARCHIVES\\par}",
        r"        \\vspace{0.14cm}",
        r"        \\AurorePill{#1}\\par\\vspace{0.10cm}",
        r"        {\\sffamily\\fontsize{27}{33}\\selectfont\\bfseries\\color{auroredeep}#2\\par}",
        r"        \\vspace{0.20cm}",
