...
def render(data):
    ...
    lines = [
        ...
        r"  \begin{tcolorbox}[enhanced,colback=white!97!aurorepale,colframe=aurorebase!30!white,arc=18pt,boxrule=.55pt,left=19pt,right=19pt,top=17pt,bottom=18pt,borderline west={3.2pt}{0pt}{auroreprimary!88!white},borderline north={0.9pt}{0pt}{auroresecondary!65!white}]%",
        r"    {\sffamily\fontsize{8.5}{10}\selectfont\bfseries\color{aurorebase!82!black}AURORE\enspace /\enspace SECTION ARCHIVES\par}",
        r"    \vspace{0.32cm}",
        r"    \AurorePill{#1}\par\vspace{0.16cm}",
        r"    {\sffamily\fontsize{27}{33}\selectfont\bfseries\color{auroredeep}#2\par}",
        r"    \vspace{0.30cm}",
        r"    \textcolor{auroreprimary}{\rule{0.14\linewidth}{1.4pt}}\par",
        r"    \vspace{0.26cm}",
