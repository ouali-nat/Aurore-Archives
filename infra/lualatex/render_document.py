...
def render(data):
    ...
    lines = [
        ...
        r"  \begin{tcolorbox}[enhanced,colback=white!98!aurorepale,colframe=aurorebase!34!white,arc=18pt,boxrule=.55pt,left=18pt,right=18pt,top=14pt,bottom=15pt,borderline west={3.0pt}{0pt}{auroreprimary!90!white},borderline north={1.0pt}{0pt}{auroresecondary!72!white}]%",
        r"    \centering",
        r"    {\sffamily\fontsize{8.6}{10}\selectfont\bfseries\color{aurorebase!82!black}AURORE\enspace /\enspace SECTION ARCHIVES\par}",
        r"    \vspace{0.16cm}",
        r"    \AurorePill{#1}\par",
        r"    \vspace{0.16cm}",
        r"    {\sffamily\fontsize{27.5}{33.5}\selectfont\bfseries\color{auroredeep}#2\par}",
        r"    \vspace{0.21cm}",
        r"    \textcolor{auroreprimary}{\rule{0.17\linewidth}{1.35pt}}\par",
        r"    \vspace{0.17cm}",
        r"    {\sffamily\small\color{aurorebase!72!black}#3\par}",
        r"    \vspace{0.14cm}",
        r"    \textcolor{auroresecondary!70!white}{\rule{0.82\linewidth}{0.35pt}}",
        r"  \end{tcolorbox}%",
        r"}",
        r"\begin{document}",
        ...
        r"\vspace*{0.35cm}",
        r"\noindent",
        r"\begin{tcolorbox}[enhanced,colback=white!98!aurorepale,colframe=auroreprimary!55!white,arc=10pt,boxrule=.65pt,left=3pt,right=3pt,top=3pt,bottom=3pt,width=1.68cm,height=1.68cm,valign=center,halign=center]",
        r"  \IfFileExists{assets/aurore-logo.png}{\includegraphics[width=1.38cm,height=1.38cm,keepaspectratio]{assets/aurore-logo.png}}{\textcolor{aurorebase}{\rule{1.02cm}{1.02cm}}}%",
        r"\end{tcolorbox}",
        r"\vspace{0.20cm}",
    ...
    if document_id is not None:
        rights_lines.extend([
            r"      \raisebox{0.22cm}[2.30cm][0pt]{\qrcode[height=2.12cm]{" + document_share_url + r"}}",
        ])
    else:
